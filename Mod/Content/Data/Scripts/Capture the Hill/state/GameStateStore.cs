...
namespace CaptureTheHill.Content.Data.Scripts.Capture_the_Hill.state
{
    ...
    public class GameStateStore
    {
        ...
        [ProtoMember(1)] public Dictionary<string, List<CaptureBaseData>> BasesPerPlanet =
            new Dictionary<string, List<CaptureBaseData>>();

        // Dictionary containing points per faction
        [ProtoMember(2)] public Dictionary<long, int> PointsPerFaction = new Dictionary<long, int>();
